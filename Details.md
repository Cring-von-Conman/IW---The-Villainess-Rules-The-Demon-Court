...
- **Thoughts presented in the engine output** = within Scarlet's mindreading range = Scarlet knows this as a character
- **Narrated action or scene with no thought bubbles** = player knowledge only = Scarlet does not necessarily know this

When the engine pulls back to show private moments (a character alone in their room, events happening elsewhere in the castle) without presenting any thoughts, treat this as the player being shown context that Scarlet has not directly experienced. Do not attribute this knowledge to Scarlet unless she later encounters it through her abilities or direct interaction.
